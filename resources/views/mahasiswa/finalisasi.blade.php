...
@section('section')
    <div class="wrapper">
        ...
        <div class="container">
            <div class="py-3">
                <form action="{{ route('finalisasi.store') }}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" id="b1" name="b1">
                                <div class="form-text">Input link Google Drive dokumen terkait</div>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" id="b2" name="b2">
                                <div class="form-text">Input link Google Drive dokumen terkait</div>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" id="b3" name="b3">
                                <div class="form-text">Input link Google Drive dokumen terkait</div>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" id="b4" name="b4">
                                <div class="form-text">Input link Google Drive dokumen terkait</div>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" id="b5" name="b5">
                                <div class="form-text">Input link Google Drive dokumen terkait</div>
                            </div>
                        </div>
                        <div class="py-2">
