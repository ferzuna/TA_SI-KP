                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name=a1 value="{{ isset($data['a1']) ? $data['a1'] : '' }}">
                            </div>
                            <div class="form-group">
                                <label for="b1">KP B1</label>
                                <input class="form-control" type="text" name="b1" value="{{ isset($data['b1']) ? $data['b1'] : '' }}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="survey" value="{{ isset($data['survey']) ? $data['survey'] : '' }}">
                            </div>
                            <div class="form-group">
                                <label for="jadwal-seminar">Jadwal Seminar</label>
                                <input class="form-control" type="datetime-local" name="jadwal" id="" value="{{ isset($data['jadwal']) ? $data['jadwal'] : '' }}">
                            </div>
                        </div>
