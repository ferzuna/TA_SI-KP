            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success border-bottom-success shadow h-100 py-2 notif-border">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-md font-weight-bold text-uppercase mb-1">Laporan Belum Diperiksa
                                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info border-bottom-info shadow h-100 py-2 notif-border">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-md font-weight-bold text-uppercase mb-1">Laporan yang sudah direvisi</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{$bimbingan1}}</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ isset($seminar->jadwal) ? Carbon\Carbon::parse($seminar->jadwal)->isoFormat('dddd, D MMMM Y | HH:mm') : "Jadwal Tidak Ada" }}</div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card card-border shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-success border-left-success alert-dismissible fade show" role="alert">
                            ...
                            Anda telah login sebagai Dosen Pembimbing KP, Silahkan menggunakan menu di panel kiri.
                        </div>
                    </div>
                </div>
